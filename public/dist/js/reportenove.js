...
$(function(){
   ...
   // all content number 
var totalContent = $("div[name='nombre[]']").length;
console.log(totalContent);
  // post number in a page
var onePageContent = 6;
  
  //Page number and Math.round for balancing page
$("div[name='nombre[]']:gt("+ (onePageContent - 1) +")").hide();
if(totalContent%2!=0){
var totalPage = Math.round(totalContent / onePageContent) + 1;
}else{
var totalPage = Math.round(totalContent / onePageContent);
  ...
  $(".pagination li").on("click", function() {
      ...
      $("div[name='nombre[]']").hide();
    
      for(i = gt - onePageContent; i < gt; i++) {      
        //$("div:[name='nombre[" + i + "]']").show();
        $("div[name='nombre[]']:eq(" + i + ")").show();
      }
...
$('#rangodefechas').daterangepicker({
         startDate: new Date(), endDate: new Date(),locale: {
            format: 'YYYY/MM/DD'
         },
